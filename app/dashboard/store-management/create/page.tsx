      ...
      <div className="flex items-start justify-between gap-4">
        <div>
          ...
          <div className="mt-1 flex items-center gap-2 text-sm font-nunito text-gray-500">
            ...
            <Link href="/dashboard/store-management" className="transition-colors hover:text-[#622581]">Store Management</Link>
            <span className="text-lg text-gray-400">›</span>
            <span className="text-gray-800">Create Store</span>
          </div>
        </div>
        <Link href="/dashboard/store-management" className="mt-1 flex items-center gap-2 whitespace-nowrap text-sm font-nunito text-[#622581] transition-colors hover:text-[#4d1d67]">
