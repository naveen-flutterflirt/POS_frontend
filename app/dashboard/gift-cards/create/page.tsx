      ...
      <div className="flex items-start justify-between gap-4">
        <div>
          ...
          <div className="mt-1 flex items-center gap-2 text-sm text-gray-500">
            <Link href="/dashboard" className="hover:text-[#622581]">Admin</Link>
        ...
        <Link href="/dashboard/gift-cards" className="mt-1 text-sm text-[#622581] hover:text-[#4d1d67]">Back to Gift Cards</Link>
      </div>
