  ...
  return (
    <div className="space-y-4 font-nunito">
      <div className="flex flex-wrap items-start justify-between gap-3">
        ...
        <Link href="/cashier/dashboard/customer/create" className="rounded-lg bg-[#622581] px-4 py-2.5 font-nunito text-sm font-semibold text-white transition-colors hover:bg-[#52206d]">
          Add Customer
        </Link>
      </div>
