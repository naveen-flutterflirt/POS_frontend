    ...
    <main className="h-dvh overflow-hidden bg-gray-50 font-nunito text-[#111111]">
      <div className="h-full overflow-hidden px-5 py-6 sm:px-8 lg:px-5">
        <div className="flex items-start justify-between gap-4">
          ...
          <Link href="/admin/dashboard/cashier/customer/create" className="rounded-xl bg-[#622581] px-5 py-2.5 text-sm font-semibold text-white transition-colors hover:bg-[#52206d] sm:px-7 sm:py-3">Add Customer</Link>
        </div>
