          ...
          <div className="w-full max-w-[505px] rounded-[22px] bg-[#f7f7f7] px-7 py-14 sm:px-10 md:px-8 lg:px-10 lg:py-16">
            ...
            <form className="space-y-6">
              ...
              <div className="text-right">
                <Link href="/forgot-password" className="font-nunito text-xs font-semibold text-gray-500 hover:text-[#1463ff]">
                  Forgot Password?
                </Link>
              </div>

              <button type="submit" className="w-full rounded-full bg-[#1463ff] py-2.5 font-poppins text-lg font-semibold text-white transition-colors hover:bg-blue-700">
                Login
              </button>

              <p className="pt-1 text-center font-nunito text-xs text-gray-500">
                Don&apos;t have an account yet?{" "}
                <Link href="/signup" className="font-semibold text-gray-500 underline hover:text-[#1463ff]">
                  Sign Up
                </Link>
              </p>
            </form>
